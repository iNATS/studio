...
import { MoreHorizontal, PlusCircle, Trash2, User } from 'lucide-react';
  ...
  return (
    <main className="flex flex-1 flex-col gap-6 w-full">
      ...
      <Card className="bg-white/5 backdrop-blur-2xl border-white/10 shadow-xl rounded-2xl">
        <CardHeader>
          <CardTitle className="text-white/90">Manage Clients</CardTitle>
          ...
          <Table>
            <TableHeader>
              <TableRow className="border-white/10 hover:bg-white/10">
                ...
                <TableHead className="hidden md:table-cell text-white/80">Company</TableHead>
            ...
            <TableBody>
              {clients.map((client) => (
                ...
                >
                  ...
                  <TableCell className="hidden md:table-cell text-white/80">{client.company}</TableCell>
                  <TableCell>

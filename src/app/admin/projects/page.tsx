          ...
          <Table>
            <TableHeader>
              <TableRow className="border-white/10 hover:bg-white/10">
                ...
                <TableHead className="hidden md:table-cell text-white/80">Tags</TableHead>
                <TableHead>
            ...
            <TableBody>
              {portfolioItems.map((project) => (
                <TableRow key={project.slug} className="border-white/10 hover:bg-white/5">
                  ...
                  <TableCell className="font-medium text-white/90">{project.title}</TableCell>
                  <TableCell>
                    <Badge variant="outline" className="text-white/70 border-white/20">{project.category}</Badge>
                  </TableCell>
                  <TableCell className="hidden md:table-cell">
                    <div className="flex flex-wrap gap-1">
                        {project.tags.slice(0, 3).map(tag => (
                             <Badge key={tag} variant="outline" className="text-white/60 border-white/10 text-xs">{tag}</Badge>
                        ))}
                    </div>
                  </TableCell>
                  <TableCell>
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button aria-haspopup="true" size="icon" variant="ghost" className="h-8 w-8 text-white/70 hover:bg-white/10 hover:text-white">

        ...
        <div className="grid md:grid-cols-3 gap-12 items-start">
          <div className="flex flex-col items-center text-center md:col-span-1">
            <Avatar className="w-40 h-40 sm:w-48 sm:h-48 border-4 border-border/80 dark:border-white/20 shadow-2xl mb-4">
              <AvatarImage src="https://firebasestudio.googleapis.com/v0/b/firebase-studio-users.appspot.com/o/images%2Fclwsdeyxi000b146q6g5zpjq2%2F1722896561139.jpeg?alt=media&token=489dc84c-f09d-43ab-898f-0a0224097950" alt="Mohamed Aref" />

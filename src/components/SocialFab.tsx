    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-center gap-2">
      {socialLinks.map((link, index) => (
        <Button
          ...
          size="icon"
          className={cn(
            'rounded-full w-14 h-14 bg-background/60 backdrop-blur-sm border border-border/40 text-primary shadow-lg transition-all duration-300 ease-in-out hover:scale-105',
